...
from TestServerApp.serializers import DepartmentSerializer, EmployeeSerializer
...
def departmentApi(request, id=0):
    if request.method == 'GET':
        ...
        if departments_serializer.is_valid():
            ...
            return JsonResponse("Data was added successfully!", safe=False)
        ...
        if departments_serializer.is_valid():
            departments_serializer.save()
            return JsonResponse("Data was Updated Successfully!", safe=False)
